...
class Constraints(ConstraintsBase):
    gt: UnionIntFloat | None = Field(None, alias="exclusiveMinimum")
    ge: UnionIntFloat | None = Field(None, alias="minimum")
    lt: UnionIntFloat | None = Field(None, alias="exclusiveMaximum")
    le: UnionIntFloat | None = Field(None, alias="maximum")
    ...
    regex: str | None = Field(None, alias="pattern")
        ...
        *,
        ...
        if additionalProperties is not None or allow_extra_fields:
            config_parameters["extra"] = (
                "Extra.allow" if additionalProperties or allow_extra_fields else "Extra.forbid"
            )
